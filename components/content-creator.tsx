...
import { Instagram, Linkedin, Twitter as X, Youtube, ImageIcon, Calendar, Send } from "lucide-react"
    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <Card className="border-4 border-black rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="mt-6 lg:hidden">
          ...
          <Switch checked={selectedPlatforms.x} onCheckedChange={() => togglePlatform("x")} />
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
